...
var arrsr3 = [];
const predefinedWordsex3 = ['user', 'web browser', 'web server', 'database'];
function addbtnt31() {
  var inpt31 = document.getElementById("inp31").value.toLowerCase();;
  ...
  if (inpt31 == "") {
    ...
    if (isInserted) {
      ...
      if (predefinedWordsex3.includes(inpt31)) {
...
function addbtnt32() {
  ...
  /* if((mtval == 2) || (mtval == 3)){
    ...
    if ((objsval3.toLowerCase() == "user") && (objrval3.toLowerCase() == "web browser") && (mtval3 == "SYNC")) {
      ...
      alert("Message passing is not possible between " + objsval3 + " and " + objrval3 + ". Please check message type.");
    }
    //document.getElementById('tbodyt33').appendChild(newtr);
...
function drawbtnex3() {
  ...
  line = new LeaderLine(clicka, clickb, {
    color: 'black', size: 2, startSocket: 'right', endSocket: 'left', hide: true, animation: true, startPlug: 'behind', endPlug: 'arrow3', endPlugSize: 2,
  ...
  line2 = new LeaderLine(httpreq, httpreq3, {
    color: 'black', size: 2, startSocket: 'right', endSocket: 'left', hide: true, startPlug: 'behind', endPlug: 'arrow3', endPlugSize: 2,
  ...
  line3 = new LeaderLine(eleuid, eleuid4, {
    color: 'black', size: 2, startSocket: 'right', endSocket: 'left', hide: true, startPlug: 'behind', endPlug: 'arrow3', endPlugSize: 2,
  ...
  line4 = new LeaderLine(elelogin4, elelogin, {
    color: 'black', size: 2, dash: true, startSocket: 'left', endSocket: 'right', hide: true, startPlug: 'behind', endPlug: 'arrow3', endPlugSize: 2,
  ...
  line5 = new LeaderLine(httpres3, httpres, {
    color: 'black', size: 2, dash: true, startSocket: 'left', endSocket: 'right', hide: true, startPlug: 'behind', endPlug: 'arrow3', endPlugSize: 2,
  ...
  line6 = new LeaderLine(upd, upd2, {
    color: 'black', size: 2, path: 'grid', startSocket: 'right', endSocket: 'right', hide: true, startPlug: 'behind', endPlug: 'arrow3', endPlugSize: 2,
